...
def NE_SIR_graph(output:np.array,  N:int = None, title:str = '', figsize:tuple = (12,5), log_scale:bool = False):
...
def SR_SIR_graph(output:np.array,  N:int = None, title:str = '', figsize:tuple = (12,5), log_scale:bool = False):
    fig, ax = plt.subplots(figsize =figsize)
    if (N == None):
        ax.plot(output[:,3], label = 'S')
...
def SR_cumulative_incidence(output:np.array,title:str = '', color:str = 'black', linestyle:str = ':',label = 'Cumulative Incidence', figsize:tuple = (12,5)):
    """
...
def NE_cumulative_incidence(output:np.array,title:str = '', color:str = 'black', linestyle:str = ':',label = 'Cumulative Incidence', figsize:tuple = (12,5)):
    """
...
def NE_plot_full_graph(output: np.array, title: str = '', figsize:tuple = (12,5), log_scale:bool = False):
    fig, ax = plt.subplots(figsize =figsize)
