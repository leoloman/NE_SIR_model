...
class SIRNE:
    ...
    def __init__(self, 
        ...
        self.dynamic_initial_state = [1 - epsilon, # 
           epsilon / (1 - epsilon), # 
        ...
        self.static_initial_state = [1 - epsilon, # theta
    ...
    def run_dynamic_simulation(self):
        ...
        """
        self.dyn_out = sp_int.odeint(self.dynamic_ode, self.initial_state, self.time, args=(self.r, self.mu, self.ro, 
    ...
    def run_static_simulation(self):
        ...
        Run a single simulation using scipy odeint function
        """
        self.static_out = sp_int.odeint(self.static_semi_random, self.static_initial_state, self.time, args=(self.r, self.mu,  
                                          self.calc_g, self.calc_g1, self.calc_g2))
